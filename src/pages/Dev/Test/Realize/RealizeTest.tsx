  ...
  return (
    <div className={styles.container}>
      ...
      <div className={styles.pages_questions}>
        ...
        <ul>
          {testData && testData.prova.provasTodasQuestoes.map((_, index) => (
            <li key={index} className={questionTab === index ? styles.tab_selected : ""} onClick={() => setQuestionTab(index)}>{index + 1}</li>
          ))}
        </ul>
      </div>
      ...
      {testData &&
        testData.prova.provasTodasQuestoes.map((question, index) => (
          <div className={`${styles.question} ${questionTab === index ? styles.active : styles.inactive}`} key={question.idQuestaoProva}>
